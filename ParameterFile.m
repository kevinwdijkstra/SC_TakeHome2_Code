D2pList = 2:10;          % do not go above 7 for MATLAB implementation or 5 for user implementation
D3pList = 2:8;          % do not go above 5 for MATLAB implementation or 3 for user implementation
...
do_IC_BIM   = false;     % execute IC BIM solvers
